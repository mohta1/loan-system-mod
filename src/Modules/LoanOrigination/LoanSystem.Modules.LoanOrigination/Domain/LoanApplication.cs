...
public enum LoanApplicationStatus { Draft, Submitted }
...
public sealed record LoanApplicationSubmitted(Guid LoanApplicationId, Guid BorrowerId, Guid LoanProductVersionId, DateTimeOffset SubmittedAtUtc);
...
{
    private readonly List<LoanApplicationSubmitted> _domainEvents = [];
    ...
    public IReadOnlyList<LoanApplicationSubmitted> DomainEvents => _domainEvents;
