...
public sealed class Borrower
{
    ...
    public string CivilNumber { get; private set; } = ""; public string? EmployeeNumber { get; private set; }
    public string FullName { get; private set; } = ""; public string? PhoneNumber { get; private set; }
    public string Nationality { get; private set; } = ""; public string Organization { get; private set; } = ""; public string? RankGrade { get; private set; }
    public string? EmploymentInformation { get; private set; }
