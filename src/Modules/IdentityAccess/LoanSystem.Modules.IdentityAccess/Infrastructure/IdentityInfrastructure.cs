...
internal static class IdentitySeed
{
    ...
    internal static readonly IReadOnlyDictionary<string, string[]> RolePermissions = new Dictionary<string, string[]>(StringComparer.Ordinal)
    {
        ...
        ["Loan Management Officer"] = ["borrowers.read", "borrowers.create", "borrowers.update", "borrowers.manageStatus", "borrowers.import", "loanProducts.read", "loanProducts.manage", "loanProducts.publish", "loanProducts.manageStatus", "loanApplications.read", "loanApplications.create", "loanApplications.update", "loanApplications.evaluateEligibility", "loanApplications.submit", "loanApplications.mortgageManage", "loanApplications.cancel", "loans.read", "loans.close", "loans.changeFinancingType", "disbursements.read", "disbursements.create", "disbursements.cancel", "repayments.read", "repayments.create", "repayments.import", "reports.read"],
