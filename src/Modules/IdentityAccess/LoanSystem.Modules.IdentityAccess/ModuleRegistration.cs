...
public static class ModuleRegistration
{
    public static IServiceCollection AddIdentityAccessModule(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        foreach (var permission in new[] { "borrowers.read", "borrowers.create", "borrowers.update", "borrowers.manageStatus", "borrowers.import", "loanProducts.read", "loanProducts.manage", "loanProducts.publish", "loanProducts.manageStatus", "loanApplications.read", "loanApplications.create", "loanApplications.update", "loanApplications.evaluateEligibility", "loanApplications.submit", "loanApplications.unitApprove", "loanApplications.committeeApprove", "loanApplications.mortgageManage", "loanApplications.finalApprove", "inspections.create", "inspections.approve", "loans.read", "loans.changeFinancingType", "disbursements.read", "disbursements.create" }) authorization.AddPolicy(permission, policy => policy.AddRequirements(new PermissionRequirement(permission)));
        return services;
    }
